...
w1 = tf.Variable(tf.random_normal(shape=[784, 400], stddev=0.01), name='weights_1', dtype=tf.float32)
b1 = tf.Variable(tf.zeros([1, 400]), name='biases_1', dtype=tf.float32)
w2 = tf.Variable(tf.random_normal(shape=[400, 400], stddev=0.01), name='weights_2', dtype=tf.float32)
b2 = tf.Variable(tf.zeros([1, 400]), name='biases_2', dtype=tf.float32)
w3 = tf.Variable(tf.random_normal(shape=[400, 10], stddev=0.01), name='weights_3', dtype=tf.float32)
